...
public class GlobalFun {
    ...
    public static final String BASE_URL = "http://wastickermaker-demo.iblinfotech.work/api/";
    ...
    //public static final String AndroidPlayStore_Link = "https://play.google.com/store/apps/details?id=" + BuildConfig.APPLICATION_ID; //"also you can put link hear"
